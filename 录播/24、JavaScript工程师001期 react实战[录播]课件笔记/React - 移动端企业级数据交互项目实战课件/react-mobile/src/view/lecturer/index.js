                                ...
                                return (
                                    <li
                                        ...
                                        onTouchEnd={(e)=>{
                                            ...
                                            if((Math.abs(nowPoint.x - e.currentTarget.point.x)+Math.abs(nowPoint.y - e.currentTarget.point.y))<5){
...
`                                                        }
    ...
    render(){
        return (
            <div>
                <MenuPage className="page lecturer-page">
